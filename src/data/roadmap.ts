...
export const foodDeliveryRoadmap: Roadmap = {
  ...
  checklist: [
    ...
    },
    {
      ...
      priority: "required",
      explanation: "Your Ghana Card is needed for identity verification. Don't have one yet? Use the link below to register.",
    ...
    },
    {
      ...
      priority: "required",
      explanation: "Choose sole proprietorship, partnership, or limited company. Tap each type below to learn what it means.",
    ...
    },
    {
      ...
      priority: "required",
      explanation: "Fill all sections accurately on the official ORC form. Upload the form in the AI assistant if you need guided help.",
    ...
    },
    {
      ...
      priority: "required",
      explanation: "Keep your payment receipt safe. Confirm the current fee on the official ORC website before paying.",
